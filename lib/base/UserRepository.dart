...
/*
  ...
  Future<FilterEntity> getFilters() async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    var u = prefs.getString(
      PrefConstant.FILTER_DATA,
    );
    if (u != null)
      return FilterEntity.fromJson(await json.decode(u));
  }
  ...
  Future<bool> saveFilter(FilterEntity userData) async {
    SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.setString(PrefConstant.FILTER_DATA, json.encode(userData.toJson()));
  }
*/
