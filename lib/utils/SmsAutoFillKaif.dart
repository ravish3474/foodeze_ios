...
class SmsAutoFillKaif {
  static SmsAutoFillKaif? _singleton;
  ...
  factory SmsAutoFillKaif() => _singleton ??= SmsAutoFillKaif._();
...
class _PhoneFieldHintState extends State<_PhoneFieldHint> {
  final SmsAutoFillKaif _autoFill = SmsAutoFillKaif();
  ...
  Future<void> _askPhoneHint() async {
   ...
   // String? code = await _autoFill._code;
    _controller.value = TextEditingValue(text: hint ?? '');

    AuthController controller = Get.put(AuthController());

  //  controller.dialCode.value=w
